...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.im = customtkinter.CTkImage(Image.open(os.path.join(image_path, "money.png")), size=(26, 26))
...
#------------------------------------------------------------------------------------
        ...
        self.second_frame_label = customtkinter.CTkLabel(self.second_frame, text="",image=self.im)
    ...
    def process_selected_file(self, file_path):
        try:
            with open(file_path, "r") as file:
                file_content = file.read()
                self.selected_file_label.configer(text=f"Selected file content:\n{file_content}")
        except Exception as e:
            self.selected_file_label.configer(text=f"Error: {str(e)}")
